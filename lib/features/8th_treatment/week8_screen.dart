...
class _Week8ScreenState extends State<Week8Screen> {
  ...
  Widget build(BuildContext context) {
    final weekDescription =
        _userName != null
            ? '$_userName님의 8주간 여정을 진심으로 축하드립니다. 이제 불안을 효과적으로 관리할 수 있는 다양한 기법들을 익히셨습니다.\n지금까지 달려온 과정을 미처 인식하지 못할 수도 있지만, 이 모든 성과는 오직 $_userName님께서 스스로 이루어낸 것입니다.'
            : '8주간의 여정을 진심으로 축하드립니다. 이제 불안을 효과적으로 관리할 수 있는 다양한 기법들을 익히셨습니다. 지금까지 달려온 과정을 미처 인식하지 못할 수도 있지만, 이 모든 성과는 오직 당신께서 스스로 이루어낸 것입니다.';
